                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold">Registration</div>
                            </div>
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <form id="Registration">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="regName" value="Jose">
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="p-6 border-gray-200 border-t">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold">Auth</div>
                            </div>
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <form id="Auth">
                        ...
                        <div class="p-6 border-gray-200 md:border-l">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold">Shortener</div>
                            </div>
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <form id="short">
            ...
            $('#regSubmit').on('click',function(){
                $.ajax({
                    ...
                    data:{
                        ...
                        Email: $('#regEmail').val(),
                        Pass: $('#regPass').val(),
                        Pass_Confirm: $('#regPass_Confirm').val()
                    },
